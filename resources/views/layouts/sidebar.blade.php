...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto">
        ...
        <a href="/dashboard" class="brand-logo">
            <img alt="Logo" src="{{ asset('img/logo.png') }}" width="150px" />
        </a>
        <!--end::Logo-->
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item {{ Request::url() == url('/dashboard') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                ...
                <li class="menu-item {{ Request::url() == url('/dashboard/log') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                    <a href="/dashboard/log" class="menu-link">
                ...
                <li class="menu-item menu-item-submenu {{ Request::url() == url('/dashboard/logout') ? 'menu-item-active' : '' }}""
                    ...
                    <a href="/dashboard/logout" class="menu-link">
                        <i class="menu-icon fas fa-sign-out-alt text-danger"></i>
